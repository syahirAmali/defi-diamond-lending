...
contract OldPinjamVaultFacet {
    ...
    function strategyHarvestOnDeposit(
        uint256 _index
    ) external view returns (bool harvestOnDeposit_) {
    ...
    function getStrategyInfo(
        ...
        external
        view
        returns (address strategy_, address yieldSource_, bool paused_)
    {
        VaultStorage.StrategyInfo memory strat = VaultStorage
            .vaultStorage()
            .strategies[_index];
